...
$sql="SELECT * FROM `frock` WHERE fdescription LIKE '%evening%'";
$result=mysqli_query($conn,$sql);
$evening=mysqli_fetch_all($result, MYSQLI_ASSOC);
//print_r($evening);
